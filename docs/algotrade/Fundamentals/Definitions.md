...
Unlike a statistical model which aims to model the underlying distribution , a casual model in addition to modelling the 
underlying distribution should be able to achieve other goals as shown in the diagram below 
<!-- ![alt text](image.png) -->
